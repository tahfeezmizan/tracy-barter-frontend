  ...
  plans = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Photo documentation", value: "check" },
        { name: "Vendor coordination", value: "check" },
        ...
        { name: "Response time (non-urgent)", value: "48 hours" },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Preventative maintenance tracking", value: "x" },
        { name: "Emergency response coordination", value: "check" },
        { name: "Response time (non-urgent)", value: "24 hours" },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Property visits", value: "Weekly" },
        { name: "Photo documentation", value: "check" },
        { name: "Vendor coordination", value: "check" },
        { name: "Storm check", value: "check" },
        { name: "Mail/package handling", value: "check" },
        ...
        { name: "Preventative maintenance tracking", value: "check" },
        { name: "Emergency response coordination", value: "check" },
        { name: "Response time (non-urgent)", value: "Same-day" },
